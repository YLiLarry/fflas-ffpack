...
struct MMHelper<Field, AlgoTrait, ModeCategories::ConvertTo<ElementCategories::RNSElementTag>, ParSeqTrait> {
    ...
    MMHelper(const Field &F, size_t m, size_t n, size_t k, ParSeqTrait PS = ParSeqTrait()) : recLevel(-1), parseq(PS) {
        F.characteristic(normA);
        F.characteristic(normB);
    }
    ...
    friend std::ostream &operator<<(std::ostream &out, const Self_t &M) {
        return out << "Helper: " << typeid(AlgoTrait).name() << ' '
                   << typeid(ModeCategories::ConvertTo<ElementCategories::RNSElementTag>).name() << ' ' << M.parseq
                   << std::endl
...
struct MMHelper<FFPACK::RNSInteger<E>, AlgoTrait, ModeCategories::DefaultTag, ParSeqTrait> {
    ...
    friend std::ostream &operator<<(std::ostream &out, const Self_t &M) {
        return out << "Helper: " << typeid(AlgoTrait).name() << ' ' << typeid(ModeCategories::DefaultTag).name() << ' '
                   << M.parseq << std::endl
                   << "  recLevel = " << M.recLevel << std::endl;
    }
};
...
inline typename FFPACK::RNSInteger<RNS>::Element_ptr fgemm(
    const FFPACK::RNSInteger<RNS> &F, const FFLAS_TRANSPOSE ta, const FFLAS_TRANSPOSE tb, const size_t m,
    const size_t n, const size_t k, const typename FFPACK::RNSInteger<RNS>::Element alpha,
    ...
    const typename FFPACK::RNSInteger<RNS>::Element beta, typename FFPACK::RNSInteger<RNS>::Element_ptr Cd,
    const size_t ldc,
    ...
    for (size_t i = 0; i < F.size(); i++) {
        ...
        FFLAS::fgemm(F.rns()._field_rns[i], ta, tb, m, n, k, alpha._ptr[i * alpha._stride], Ad._ptr + i * Ad._stride,
                     lda, Bd._ptr + i * Bd._stride, ldb, beta._ptr[i * beta._stride], Cd._ptr + i * Cd._stride, ldc,
                     H2);
    }
#ifdef PROFILE_FGEMM_MP
    t.stop();
...
fgemm(const FFPACK::RNSInteger<RNS> &F, const FFLAS_TRANSPOSE ta, const FFLAS_TRANSPOSE tb, const size_t m,
      const size_t n, const size_t k, const typename FFPACK::RNSInteger<RNS>::Element alpha,
      typename FFPACK::RNSInteger<RNS>::ConstElement_ptr Ad, const size_t lda,
      typename FFPACK::RNSInteger<RNS>::ConstElement_ptr Bd, const size_t ldb,
      const typename FFPACK::RNSInteger<RNS>::Element beta, typename FFPACK::RNSInteger<RNS>::Element_ptr Cd,
      ...
      MMHelper<FFPACK::RNSInteger<RNS>, MMHelperAlgo::Classic, ModeCategories::DefaultTag,
               ParSeqHelper::Parallel<Cut, Param>> &H) {
    // compute each fgemm componentwise
    size_t s = F.size();
    ...
    t.start();
#endif
    typedef MMHelper<typename RNS::ModField, MMHelperAlgo::Winograd, typename ModeTraits<typename RNS::ModField>::value,
                     ParSeqHelper::Parallel<Cut, Param>>
        MMH_par_t;
...
fgemm(const Givaro::ZRing<Givaro::Integer> &F, const FFLAS_TRANSPOSE ta, const FFLAS_TRANSPOSE tb, const size_t m,
      const size_t n, const size_t k, const Givaro::Integer alpha, const Givaro::Integer *A, const size_t lda,
      const Givaro::Integer *B, const size_t ldb, Givaro::Integer beta, Givaro::Integer *C, const size_t ldc,
      MMHelper<Givaro::ZRing<Givaro::Integer>, MMHelperAlgo::Classic,
...
inline typename RNS::Element_ptr
fgemm(const FFPACK::RNSInteger<RNS> &F, const FFLAS_TRANSPOSE ta, const FFLAS_TRANSPOSE tb, const size_t m,
      const size_t n, const size_t k, const typename RNS::Element alpha, typename RNS::ConstElement_ptr Ad,
      const size_t lda, typename RNS::ConstElement_ptr Bd, const size_t ldb, const typename RNS::Element beta,
    ...
    MMHelper<FFPACK::RNSInteger<RNS>, MMHelperAlgo::Classic, ModeT, ParSeqHelper::Sequential> H2(F, H.recLevel,
                                                                                                 H.parseq);
...
//        MMHelper<Givaro::ZRing<Givaro::Integer>, MMHelperAlgo::Winograd,
//        ModeCategories::ConvertTo<ElementCategories::RNSElementTag>, ParSeq >  & H)
// {
// 	MMHelper<Givaro::ZRing<Givaro::Integer>, MMHelperAlgo::Classic,
// ModeCategories::ConvertTo<ElementCategories::RNSElementTag>, ParSeq> H2(F, H.recLevel,H.parseq); 	return
// fgemm(F,ta,tb,m,n,k,alpha,A,lda,B,ldb,beta,C,ldc,H2);
...
template <typename RNS>
inline typename RNS::Element_ptr
fgemm(const FFPACK::RNSIntegerMod<RNS> &F, const FFLAS_TRANSPOSE ta, const FFLAS_TRANSPOSE tb, const size_t m,
      const size_t n, const size_t k, const typename RNS::Element alpha, typename RNS::ConstElement_ptr Ad,
      const size_t lda, typename RNS::ConstElement_ptr Bd, const size_t ldb, const typename RNS::Element beta,
      typename RNS::Element_ptr Cd, const size_t ldc, MMHelper<FFPACK::RNSIntegerMod<RNS>, MMHelperAlgo::Winograd> &H) {
...
inline Givaro::Integer *fgemm(const Givaro::Modular<Givaro::Integer> &F, const FFLAS_TRANSPOSE ta,
                              const FFLAS_TRANSPOSE tb, const size_t m, const size_t n, const size_t k,
                              const Givaro::Integer alpha, const Givaro::Integer *A, const size_t lda,
                              const Givaro::Integer *B, const size_t ldb, const Givaro::Integer beta,
                              Givaro::Integer *C, const size_t ldc,
                              MMHelper<Givaro::Modular<Givaro::Integer>, MMHelperAlgo::Classic,
    ...
    F.cardinality(p);
    IntegerDomain Z;
    MMHelper<IntegerDomain, MMHelperAlgo::Classic, ModeCategories::ConvertTo<ElementCategories::RNSElementTag>> H2(
        Z, H.recLevel, H.parseq);
    H2.setNorm(p);
...
template <class ParSeq>
inline Givaro::Integer *
fgemm(const Givaro::Modular<Givaro::Integer> &F, const FFLAS_TRANSPOSE ta, const FFLAS_TRANSPOSE tb, const size_t m,
      const size_t n, const size_t k, const Givaro::Integer alpha, const Givaro::Integer *A, const size_t lda,
      const Givaro::Integer *B, const size_t ldb, const Givaro::Integer beta, Givaro::Integer *C, const size_t ldc,
      MMHelper<Givaro::Modular<Givaro::Integer>, MMHelperAlgo::Auto,
               ModeCategories::ConvertTo<ElementCategories::RNSElementTag>, ParSeq> &H) {
    // compute the product over Z
    ...
    F.cardinality(p);
    IntegerDomain Z;
    MMHelper<IntegerDomain, MMHelperAlgo::Classic, ModeCategories::ConvertTo<ElementCategories::RNSElementTag>, ParSeq>
        H2(Z, H.recLevel, H.parseq);
    H2.setNorm(p);
...
// 							   Givaro::Integer beta,
// 							   Givaro::Integer* C, const size_t ldc,
// 							   MMHelper<Givaro::ZRing<Givaro::Integer>,MMHelperAlgo::Winograd,FieldCategories::UnparametricTag,ParSeqHelper::Parallel<Cut,Param>
// > & H){ 	MMHelper<Givaro::ZRing<Givaro::Integer>,MMHelperAlgo::Winograd> H2(F,H.recLevel); 	return
// fgemm(F,ta,tb,m,n,k,alpha,A,lda,B,lda,beta,C,ldc,H2);
// }

// fgemm with Modular<ruint<K1,K2> >
template <size_t K1, size_t K2, class ParSeq>
inline RecInt::ruint<K1> *fgemm(const Givaro::Modular<RecInt::ruint<K1>, RecInt::ruint<K2>> &F,
                                const FFLAS_TRANSPOSE ta, const FFLAS_TRANSPOSE tb, const size_t m, const size_t n,
                                const size_t k, const RecInt::ruint<K1> alpha, const RecInt::ruint<K1> *A,
                                const size_t lda, const RecInt::ruint<K1> *B, const size_t ldb, RecInt::ruint<K1> beta,
